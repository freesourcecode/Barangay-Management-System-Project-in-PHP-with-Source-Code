...
<body>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row bg-success">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center bg-success">
          <a class="navbar-brand brand-logo" href="<?php echo base_url() ?>">Expense Management</a>
...
<div id="id01" class="w3-modal">
 <div class="w3-modal-content w3-card-4 w3-animate-zoom">
  ...
  <div class="w3-bar w3-border-bottom">
   <button class="tablink w3-bar-item w3-button text-danger" onclick="openCity(event, 'London')"><b>Manage Expenses</b></button>
   <button class="tablink w3-bar-item w3-button text-dark" onclick="openCity(event, 'Paris')"><b>Receive Amount</b></button>
...
-->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas btn-gradient-success" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item sidebar-actions">
            <span class="nav-link">
              ...
              <button  onclick="document.getElementById('id01').style.display='block'" class="btn btn-block btn-lg btn-gradient-dark mt-4">Add Data </button>
